...
FILENAME="configs/optimal_threads_6.ini"
...
echo "kernels_0: \"shared_memory_read_large\"" >> $FILENAME
...
sh send-encrypted.sh -k qGE5Pn -p Archimedes -s klvlqmhb -t "Experiments complete" -m "Optimal threads 6 completed! Time taken: $DIFF seconds"
