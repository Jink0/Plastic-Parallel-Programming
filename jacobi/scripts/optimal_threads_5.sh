...
FILENAME="configs/optimal_threads_5.ini"
...
sh send-encrypted.sh -k qGE5Pn -p Archimedes -s klvlqmhb -t "Experiments complete" -m "Optimal threads 5 completed! Time taken: $DIFF seconds"
