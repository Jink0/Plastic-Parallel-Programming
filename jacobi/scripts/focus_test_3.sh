...
MULPD_KERNEL_REPEATS_MIN=100
MULPD_KERNEL_REPEATS_MAX=1000
MULPD_KERNEL_REPEATS_STEP=100
...
FILENAME="configs/focus_test_3.ini"
...
for ((i=$MULPD_KERNEL_REPEATS_MIN; i<=$MULPD_KERNEL_REPEATS_MAX; i+=$MULPD_KERNEL_REPEATS_STEP))
do
